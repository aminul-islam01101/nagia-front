...
import { useGetAllOpportunityTitlesQuery } from '@/states/services/overlappingApi';

const InvestmentCalculator = () => {
  const { data: opportunityTitles, isLoading, isError, isFetching: isLoadingOpp } =
    useGetAllOpportunityTitlesQuery(undefined);
  ...
  const productOptions = opportunityTitles?.data;
